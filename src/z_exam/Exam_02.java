...
public class Exam_02 {
	public static void main(String[] args) {
		...
		초기화 하는 한 줄의 코드를 적으시오.(-뺴고)
		 long regNo = 9308021183719L;
		...
		b. True, c. NULL, d. Class, e. System(예약어의 경우 자주색으로 나타난다.)
		...
		e. i = (int)ch; 는 int가 ch보다 크기 떄문에 형변환을 생략할 수 있다.
		...
		a. byte(범위), b. char c(공백), c. char answer(글자수)   
